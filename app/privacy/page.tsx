        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">当サイトでは、以下の情報を収集する場合があります：</p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>アクセスログ（IPアドレス、ブラウザ情報、アクセス日時等）</li>
                <li>Cookie及び類似技術による情報</li>
                <li>お問い合わせフォームに入力された情報（お名前、メールアドレス等）</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">2. 情報の利用目的</h2>
              <p className="text-gray-700 mb-4">収集した情報は以下の目的で利用いたします：</p>
              <ul className="list-disc pl-6 text-gray-700 space-y-2">
                <li>サイトの運営・改善</li>
                <li>ユーザーサポート</li>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Cookieについて</h2>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">4. アクセス解析ツールについて</h2>
              <p className="text-gray-700 mb-4">
                当サイトでは、Google Analyticsなどのアクセス解析ツールを使用する場合があります。これらのツールはCookieを使用してユーザーの行動を分析しますが、個人を特定する情報は含まれません。
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">5. 第三者への提供</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">6. 個人情報の管理</h2>
              <p className="text-gray-700 mb-4">
