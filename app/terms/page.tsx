      ...
      <div className="w-[90%] max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第2条（利用資格）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第4条（著作権）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第6条（サービス内容の変更等）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第7条（利用規約の変更）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第8条（個人情報の取扱い）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第9条（通知または連絡）</h2>
              <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">第10条（権利義務の譲渡の禁止）</h2>
              <p className="text-gray-700 mb-4">
